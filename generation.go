...
import (
	...
	"github.com/honeyhive-ai/honeyhive-go-sdk/pkg/utils"
	"net/http"
	"strings"
)
...
func (s *generation) IngestSingleGeneration(ctx context.Context, request shared.SingleGenerationInput) (*operations.IngestSingleGenerationResponse, error) {
	baseURL := s.serverURL
